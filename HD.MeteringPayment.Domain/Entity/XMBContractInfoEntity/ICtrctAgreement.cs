...
{
    [ServiceContract]
    public interface ICtrctAgreement
    {
        /// <summary>
        /// 获取列表
        /// </summary>
        ...
        [OperationContract]
        List<CtrctAgreement> GetList(string whereQuery);
        ...
        //[FaultContract(typeof(ApplicationServiceError))]
        //[OperationContract]
        //ProjectDepInfo Add(ProjectDepInfo entity, string operationBy);
        ...
        //[FaultContract(typeof(ApplicationServiceError))]
        //[OperationContract]
        //ProjectDepInfo Update(ProjectDepInfo entity, string operationBy);
