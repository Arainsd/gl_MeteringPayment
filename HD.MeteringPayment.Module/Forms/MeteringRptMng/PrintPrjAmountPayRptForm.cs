...
{
    public partial class PrintPrjAmountPayRptForm : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public PrintPrjAmountPayRptForm()
        {
            InitializeComponent();
        }


        private void SetX0Value(List<PrjAmountPayRpt> detail)
        {
            ...
            for (int i = 1; i <= Range; i++)
            {
                switch (i)
                {
                    case 1:
                        {
                            x0_1_1.Text = (detail[i - 1].CtrctAmount ?? 0) != 0 ? (detail[i - 1].CtrctAmount ?? 0).ToString("n0") : "";
                            x0_1_2.Text = (detail[i - 1].ChangeAmount ?? 0) != 0 ? (detail[i - 1].ChangeAmount ?? 0).ToString("n0") : "";
                            x0_1_3.Text = (detail[i - 1].LatestAmount ?? 0) != 0 ? (detail[i - 1].LatestAmount ?? 0).ToString("n0") : "";
                            x0_1_4.Text = (detail[i - 1].EndingAmount ?? 0) != 0 ? (detail[i - 1].EndingAmount ?? 0).ToString("n0") : "";
                            x0_1_5.Text = (detail[i - 1].EndingProp ?? 0) != 0 ? (detail[i - 1].EndingProp ?? 0).ToString("p") : "";
                            x0_1_6.Text = (detail[i - 1].StartingAmount ?? 0) != 0 ? (detail[i - 1].StartingAmount ?? 0).ToString("n0") : "";
                            x0_1_7.Text = (detail[i - 1].LastProp ?? 0) != 0 ? (detail[i - 1].LastProp ?? 0).ToString("p") : "";
                            x0_1_8.Text = (detail[i - 1].Amount ?? 0) != 0 ? (detail[i - 1].Amount ?? 0).ToString("n0") : "";
                            x0_1_9.Text = (detail[i - 1].Prop ?? 0) != 0 ? (detail[i - 1].Prop ?? 0).ToString("p") : "";
                        }
                        break;
                    case 2:
                        {
                            x0_2_1.Text = (detail[i - 1].CtrctAmount ?? 0) != 0 ? (detail[i - 1].CtrctAmount ?? 0).ToString("n0") : "";
                            x0_2_2.Text = (detail[i - 1].ChangeAmount ?? 0) != 0 ? (detail[i - 1].ChangeAmount ?? 0).ToString("n0") : "";
                            x0_2_3.Text = (detail[i - 1].LatestAmount ?? 0) != 0 ? (detail[i - 1].LatestAmount ?? 0).ToString("n0") : "";
                            x0_2_4.Text = (detail[i - 1].EndingAmount ?? 0) != 0 ? (detail[i - 1].EndingAmount ?? 0).ToString("n0") : "";
                            x0_2_5.Text = (detail[i - 1].EndingProp ?? 0) != 0 ? (detail[i - 1].EndingProp ?? 0).ToString("p") : "";
                            x0_2_6.Text = (detail[i - 1].StartingAmount ?? 0) != 0 ? (detail[i - 1].StartingAmount ?? 0).ToString("n0") : "";
                            x0_2_7.Text = (detail[i - 1].LastProp ?? 0) != 0 ? (detail[i - 1].LastProp ?? 0).ToString("p") : "";
                            x0_2_8.Text = (detail[i - 1].Amount ?? 0) != 0 ? (detail[i - 1].Amount ?? 0).ToString("n0") : "";
                            x0_2_9.Text = (detail[i - 1].Prop ?? 0) != 0 ? (detail[i - 1].Prop ?? 0).ToString("p") : "";
                        }
                        break;
                    case 3:
                        {
                            x0_3_1.Text = (detail[i - 1].CtrctAmount ?? 0) != 0 ? (detail[i - 1].CtrctAmount ?? 0).ToString("n0") : "";
                            x0_3_2.Text = (detail[i - 1].ChangeAmount ?? 0) != 0 ? (detail[i - 1].ChangeAmount ?? 0).ToString("n0") : "";
                            x0_3_3.Text = (detail[i - 1].LatestAmount ?? 0) != 0 ? (detail[i - 1].LatestAmount ?? 0).ToString("n0") : "";
                            x0_3_4.Text = (detail[i - 1].EndingAmount ?? 0) != 0 ? (detail[i - 1].EndingAmount ?? 0).ToString("n0") : "";
                            x0_3_5.Text = (detail[i - 1].EndingProp ?? 0) != 0 ? (detail[i - 1].EndingProp ?? 0).ToString("p") : "";
                            x0_3_6.Text = (detail[i - 1].StartingAmount ?? 0) != 0 ? (detail[i - 1].StartingAmount ?? 0).ToString("n0") : "";
                            x0_3_7.Text = (detail[i - 1].LastProp ?? 0) != 0 ? (detail[i - 1].LastProp ?? 0).ToString("p") : "";
                            x0_3_8.Text = (detail[i - 1].Amount ?? 0) != 0 ? (detail[i - 1].Amount ?? 0).ToString("n0") : "";
                            x0_3_9.Text = (detail[i - 1].Prop ?? 0) != 0 ? (detail[i - 1].Prop ?? 0).ToString("p") : "";
                        }
                        break;
                    case 4:
                        {
                            x0_4_1.Text = (detail[i - 1].CtrctAmount ?? 0) != 0 ? (detail[i - 1].CtrctAmount ?? 0).ToString("n0") : "";
                            x0_4_2.Text = (detail[i - 1].ChangeAmount ?? 0) != 0 ? (detail[i - 1].ChangeAmount ?? 0).ToString("n0") : "";
                            x0_4_3.Text = (detail[i - 1].LatestAmount ?? 0) != 0 ? (detail[i - 1].LatestAmount ?? 0).ToString("n0") : "";
                            x0_4_4.Text = (detail[i - 1].EndingAmount ?? 0) != 0 ? (detail[i - 1].EndingAmount ?? 0).ToString("n0") : "";
                            x0_4_5.Text = (detail[i - 1].EndingProp ?? 0) != 0 ? (detail[i - 1].EndingProp ?? 0).ToString("p") : "";
                            x0_4_6.Text = (detail[i - 1].StartingAmount ?? 0) != 0 ? (detail[i - 1].StartingAmount ?? 0).ToString("n0") : "";
                            x0_4_7.Text = (detail[i - 1].LastProp ?? 0) != 0 ? (detail[i - 1].LastProp ?? 0).ToString("p") : "";
                            x0_4_8.Text = (detail[i - 1].Amount ?? 0) != 0 ? (detail[i - 1].Amount ?? 0).ToString("n0") : "";
                            x0_4_9.Text = (detail[i - 1].Prop ?? 0) != 0 ? (detail[i - 1].Prop ?? 0).ToString("p") : "";
                        }
                        break;
                    case 5:
                        {
                            x0_5_1.Text = (detail[i - 1].CtrctAmount ?? 0) != 0 ? (detail[i - 1].CtrctAmount ?? 0).ToString("n0") : "";
                            x0_5_2.Text = (detail[i - 1].ChangeAmount ?? 0) != 0 ? (detail[i - 1].ChangeAmount ?? 0).ToString("n0") : "";
                            x0_5_3.Text = (detail[i - 1].LatestAmount ?? 0) != 0 ? (detail[i - 1].LatestAmount ?? 0).ToString("n0") : "";
                            x0_5_4.Text = (detail[i - 1].EndingAmount ?? 0) != 0 ? (detail[i - 1].EndingAmount ?? 0).ToString("n0") : "";
                            x0_5_5.Text = (detail[i - 1].EndingProp ?? 0) != 0 ? (detail[i - 1].EndingProp ?? 0).ToString("p") : "";
                            x0_5_6.Text = (detail[i - 1].StartingAmount ?? 0) != 0 ? (detail[i - 1].StartingAmount ?? 0).ToString("n0") : "";
                            x0_5_7.Text = (detail[i - 1].LastProp ?? 0) != 0 ? (detail[i - 1].LastProp ?? 0).ToString("p") : "";
                            x0_5_8.Text = (detail[i - 1].Amount ?? 0) != 0 ? (detail[i - 1].Amount ?? 0).ToString("n0") : "";
                            x0_5_9.Text = (detail[i - 1].Prop ?? 0) != 0 ? (detail[i - 1].Prop ?? 0).ToString("p") : "";
                        }
                        break;
                } 
            }
        ...
        {
            int Range = detail.Count < 3 ? detail.Count : 3;
            for (int i = 1; i <= Range; i++)
            {
                switch (i)
                {
        ...
        private void SetX2Value(List<PrjAmountPayRpt> detail)
        {
            ...
            for (int i = 1; i <= Range; i++)
            {
                switch (i)
                {
                    case 1:
                        {
                            x2_1_1.Text = (detail[i - 1].CtrctAmount ?? 0) != 0 ? (detail[i - 1].CtrctAmount ?? 0).ToString("n0") : "";
                            x2_1_2.Text = (detail[i - 1].ChangeAmount ?? 0) != 0 ? (detail[i - 1].ChangeAmount ?? 0).ToString("n0") : "";
                            x2_1_3.Text = (detail[i - 1].LatestAmount ?? 0) != 0 ? (detail[i - 1].LatestAmount ?? 0).ToString("n0") : "";
                            x2_1_4.Text = (detail[i - 1].EndingAmount ?? 0) != 0 ? (detail[i - 1].EndingAmount ?? 0).ToString("n0") : "";
                            x2_1_5.Text = (detail[i - 1].EndingProp ?? 0) != 0 ? (detail[i - 1].EndingProp ?? 0).ToString("p") : "";
                            x2_1_6.Text = (detail[i - 1].StartingAmount ?? 0) != 0 ? (detail[i - 1].StartingAmount ?? 0).ToString("n0") : "";
                            x2_1_7.Text = (detail[i - 1].LastProp ?? 0) != 0 ? (detail[i - 1].LastProp ?? 0).ToString("p") : "";
                            x2_1_8.Text = (detail[i - 1].Amount ?? 0) != 0 ? (detail[i - 1].Amount ?? 0).ToString("n0") : "";
                            x2_1_9.Text = (detail[i - 1].Prop ?? 0) != 0 ? (detail[i - 1].Prop ?? 0).ToString("p") : "";
                        }
                        break;
                    case 2:
                        {
                            x2_2_1.Text = (detail[i - 1].CtrctAmount ?? 0) != 0 ? (detail[i - 1].CtrctAmount ?? 0).ToString("n0") : "";
                            x2_2_2.Text = (detail[i - 1].ChangeAmount ?? 0) != 0 ? (detail[i - 1].ChangeAmount ?? 0).ToString("n0") : "";
                            x2_2_3.Text = (detail[i - 1].LatestAmount ?? 0) != 0 ? (detail[i - 1].LatestAmount ?? 0).ToString("n0") : "";
                            x2_2_4.Text = (detail[i - 1].EndingAmount ?? 0) != 0 ? (detail[i - 1].EndingAmount ?? 0).ToString("n0") : "";
                            x2_2_5.Text = (detail[i - 1].EndingProp ?? 0) != 0 ? (detail[i - 1].EndingProp ?? 0).ToString("p") : "";
                            x2_2_6.Text = (detail[i - 1].StartingAmount ?? 0) != 0 ? (detail[i - 1].StartingAmount ?? 0).ToString("n0") : "";
                            x2_2_7.Text = (detail[i - 1].LastProp ?? 0) != 0 ? (detail[i - 1].LastProp ?? 0).ToString("p") : "";
                            x2_2_8.Text = (detail[i - 1].Amount ?? 0) != 0 ? (detail[i - 1].Amount ?? 0).ToString("n0") : "";
                            x2_2_9.Text = (detail[i - 1].Prop ?? 0) != 0 ? (detail[i - 1].Prop ?? 0).ToString("p") : "";
                        }
                        break;
                    case 3:
                        {
